...
process.stdout.write(require('../lib/index.js').help({
    ...
    sections: {
        Details: {
            ...
            options: {
                ...
                '-o': 'Another test switch, but this time a bit more circular and minimal in appearance. All the rage with the hipsters.',
